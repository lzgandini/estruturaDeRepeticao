...
o cliente comprou e ao lado o valor da conta. Desta forma a atendente do caixa precisa apenas contar quantos itens o cliente
...
for indice in range(1, 51):
    calculo = indice * preco
    print("{} - R$ {:.2f}".format(indice, calculo))
